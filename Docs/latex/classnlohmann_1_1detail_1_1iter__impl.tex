...
\subsubsection[{\texorpdfstring{iter\+\_\+impl()=default}{iter_impl()=default}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Basic\+Json\+Type$>$ {\bf iter\+\_\+impl}$<$ typename std\+::conditional$<$ std\+::is\+\_\+const$<$ Basic\+Json\+Type $>$\+::{\bf value}, typename std\+::remove\+\_\+const$<$ Basic\+Json\+Type $>$\+::type, {\bf const} Basic\+Json\+Type $>$\+::type $>$ (
...
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf iter\+\_\+impl}$<$ typename std\+::remove\+\_\+const$<$ Basic\+Json\+Type $>$\+::type $>$ \&}]{other}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf iter\+\_\+impl}$<$ Basic\+Json\+Type $>$ \&}]{other}
\end{DoxyParamCaption}
...
\index{nlohmann\+::detail\+::iter\+\_\+impl@{nlohmann\+::detail\+::iter\+\_\+impl}!operator++@{operator++}}
\index{operator++@{operator++}!nlohmann\+::detail\+::iter\+\_\+impl@{nlohmann\+::detail\+::iter\+\_\+impl}}
\subsubsection[{\texorpdfstring{operator++(int)}{operator++(int)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Basic\+Json\+Type$>$ {\bf iter\+\_\+impl} {\bf const} {\bf nlohmann\+::detail\+::iter\+\_\+impl}$<$ Basic\+Json\+Type $>$\+::operator++ (
\begin{DoxyParamCaption}
\item[{int}]{}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{{\bf difference\+\_\+type}}]{i, }
\item[{{\bf const} {\bf iter\+\_\+impl}$<$ Basic\+Json\+Type $>$ \&}]{it}
\end{DoxyParamCaption}
