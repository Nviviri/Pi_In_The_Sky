...
/// to receive a PINGRESP from the broker. The keep alive period is in seconds.
///
/// A typical value might be 60 (seconds). This means that the MQTT client is
/// expected to send an MQTT packet at least once every #MQTT_KEEP_ALIVE
/// seconds.
